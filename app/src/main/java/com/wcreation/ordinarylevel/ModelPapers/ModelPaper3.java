...
public class ModelPaper3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_model_paper3);
        ...
        webView.loadUrl("https://drive.google.com/open?id=1aJMWUXoFIVrFRRjjz21IfmVJp-soboP2");
