...
public class ModelPaper2Part1Answer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_model_paper2_part1_answer);
        ...
        webView.loadUrl("https://drive.google.com/open?id=1iYUyXUmoyuQKliVE7nl92a7h1YmelKPG");
