...
public class ModelPaper1Part2Answer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_model_paper1_part2_answer);
        ...
        webView.loadUrl("https://drive.google.com/open?id=10sw7-itEJC4m5tHqFEwtyNGp-clQQJIa");
