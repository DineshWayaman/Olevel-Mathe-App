...
public class ModelPaper2Part2Answer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_model_paper2_part2_answer);
        ...
        webView.loadUrl("https://drive.google.com/open?id=1BWT5PUIH6VSXEy7ykqHn9BJQlYere-Yw");
