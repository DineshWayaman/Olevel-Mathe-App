...
public class ModelPaper2Part1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_model_paper2_part1);
        ...
        webView.loadUrl("https://drive.google.com/open?id=1ENMEdIGFAVUUIWe-aJI5LOSjlDoEewVK");
